---
title: "Analysis of Eden Landing using MEM-PEPRMT"
...
# with(test_graph, plot(avg_Pulse_Emission_Total~index,
#      type = "l",
#      col = "black",
#      yaxt = "n"))
# lines(test_graph$M1, col = "magenta")
# lines(test_graph$M2, col = "red")
#lines(test_graph$plant_flux, col = "green")
#lines(test_graph$hydro_flux, col = "blue")
#title(main = "methane outputs of peprmt ch4")
...
#                                    "red", 
#                                    "green"),
#       legend = c("avg_pulse_emission", "m1", "m2","hydro","plant"))
#axis(2, at=seq(-5, 5, by = 0.5), las = 2)
...
Now calculate the your summary statistics of between the observed and predicted values: cumulative sums, sums, r-squared, and rmse.
...
#r time series linear regression model
#fit1 <- lm(mm~time(mm))
```
...
#5.d) unit change on the microsite column
...
## 1. Reco graphing function


# library(tictoc)
# year_vector = c(2018)
# input_dir =  './supporting_scripts/MEM_inputs_EL.R'
# matlab_dir = './Data_sets/EL_2018_master.mat'
# 
# source(file = './MEM-PEP_production_Reco_graphoutput.R')
# tic()
# MEM_PEPRMT_Reco(year_vector, input_dir, matlab_dir)
# toc()
```


```{r eval=FALSE, include = FALSE}
## 2. Reco data ouput function

# year_vector = c(2016,2017)
# input_dir =  './support_scripts/inputs_V2.R'
# matlab_dir = './data/RR_2016_2017_master.mat'
# tower_data= './data/pep_RR_reco.rds'
# 
# source(file = './MEM-PEP_production_Reco_data_ouput.R')
# tic()
# Reco_output(year_vector, input_dir, matlab_dir,tower_data)
# toc()
